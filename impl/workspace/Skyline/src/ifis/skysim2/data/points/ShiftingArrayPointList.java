...
public class ShiftingArrayPointList implements ArrayPointList {
	...
	// public PointRelationship compare(int indexA, ShiftingArrayPointList
	// listB, int indexB) {
	// return PointComparator.compare(this.points, d * indexA, listB.points, d *
	// indexB, d);
	// }
	...
	private class PointListArrayListIterator implements PointListIterator {
		...
		public void moveToFront() {
			if (cursor != 0) {
				float[] current = Arrays
						.copyOfRange(points, cursor, cursor + d);
