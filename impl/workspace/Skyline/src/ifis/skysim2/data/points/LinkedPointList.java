...
public class LinkedPointList implements PointSource, PointList {
	 ...
	 * add them to the tail of the current list.. Simply steals all elements
	 * when you try to steal more than there is available (no exceptions
	 * thrown).
	 * 
	 * @param victim
	 *            the list from where to steal elements
	 * @param elementsToMove
	 *            the number of elements to steal
	 */
	...
	private static class DataNode {
		...
		private DataNode(final float[] point, final float key,
				final DataNode next) {
